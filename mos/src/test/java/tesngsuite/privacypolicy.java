...
public class privacypolicy {
	@Test
	  ...
	  public void f(String url,String path) throws InterruptedException 
	  {
		  ...
		  String Expectedurl="https://www.swinkpay-fintech.com/privacy-policy";
		  boolean isdisplayedstatus= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[3]")).isDisplayed();
		  boolean isenabledstatus= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[3]")).isEnabled();
		  String textlinename=driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[3]")).getText();
		  driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[3]")).click();
