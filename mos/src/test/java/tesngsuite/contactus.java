...
public class contactus 
{
	@Test
	  ...
	  public void f(String url,String path) throws InterruptedException 
	  {
		  ...
		  String Expectedurl="https://www.swinkpay-fintech.com/contact-us";
		  boolean isdisplayedstatus= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[5]")).isDisplayed();
		  boolean isenabledstatus= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[5]")).isEnabled();
		  String textlinename=driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[5]")).getText();
		  driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[5]")).click();
