...
public class aboutuslink {
	@Test
	  ...
	  public void f(String url,String path) throws InterruptedException 
	  {
		  ...
		  String Expectedurl="https://www.swinkpay-fintech.com/about-us/introduction";
		  boolean isdisplayedstatus= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[2]")).isDisplayed();
		  boolean isenabledstatus= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[2]")).isEnabled();
		  String textlinename=driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[2]")).getText();
		  driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/footer/div/div/a[2]")).click();
